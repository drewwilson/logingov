      ...
      <div>
        ...
        <div class="card" id="card-social">
          ...
          <div class="card-body">
            ...
            <button class="btn-block" onclick="socialSignIn('microsoft')" style="background:#2f2f2f;color:#fff;display:flex;align-items:center;justify-content:center;gap:0.5rem;">
...
demoRoute.post("/demo/seed-sp", async (c) => {
  ...
  await db.insert(serviceProviders).values({
    ...
    theme: JSON.stringify({
      logo: "",
      agencyName: "Example Demo App",
      primaryColor: "#1a4480",
      heroPanel: "https://upload.wikimedia.org/wikipedia/commons/thumb/a/a8/USDA_Beltsville_Agricultural_Research_Center.jpg/1280px-USDA_Beltsville_Agricultural_Research_Center.jpg",
      backLinkText: "Back to Example.gov",
      backLinkUrl: "https://example.gov",
      secondaryLinkText: "Forgot?",
      formBackground: { color: "#f0f4f8" },
    }),
