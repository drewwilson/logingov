...
import type { SPThemeConfig } from "@logingov/hosted-ui/types";
...
app.put("/api/agencies/:id", async (c) => {
  try {
    ...
    if (body.iaaName !== undefined) updates.iaaName = body.iaaName;
    if (body.friendlyName !== undefined) updates.friendlyName = body.friendlyName;
    if (body.abbreviation !== undefined) updates.abbreviation = body.abbreviation || null;
    ...
    if (body.ial !== undefined) updates.ial = body.ial;
    if (body.defaultAal !== undefined) updates.defaultAal = body.defaultAal;
    if (body.logo !== undefined) updates.logo = body.logo || null;
    if (body.publicCertificate !== undefined) updates.publicCertificate = body.publicCertificate || null;
    if (body.status !== undefined) updates.status = body.status;
    if (body.themeConfig !== undefined) updates.themeConfig = body.themeConfig ? JSON.stringify(body.themeConfig) : null;
